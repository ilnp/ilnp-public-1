...
/* The method is added by dp32 to send ILNPv6 Locator Update (LU) message*/
/* Migrated into 4x code from 3x ilnp codes by ry6 */
extern void 				icmpv6_send_lu(struct sk_buff *skb,
