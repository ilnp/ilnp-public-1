...
#define PKT_TYPE_OFFSET()	offsetof(struct sk_buff, __pkt_type_offset)
	...
	/* Migrated from ILNP on linux 3.9.7 by ry6 */
	unsigned int 		has_nonce;	// Add by dp32, use to check if the packet has nonce option
	unsigned int		is_ilnp;	// Add by dp32, use to check if the packet is ILNP or not
